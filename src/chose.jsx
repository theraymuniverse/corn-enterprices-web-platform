        ...
        className='text-black'>
          ...
          <div className='lg:flex-row flex  flex-col '>
            <span className='lg:p-[20px] md:text-[20px] text-[16px] pt-[30px] sm:text-[18px] mt-[20px] lg:md:mt-[100px]'>
               ...
               <button className='border ml-[50px] border-green-500 hover:bg-green-900 duration-500 hover:text-white rounded-md cursor-pointer text-center lg:ml-[120px] mt-[30px] justify-center  text-green-500 mt-[20px] px-[30px] py-[15px]'>Learn More</button>             
              
              </span>
            <img src={third} loading='lazy' className='md:w-[2500px] lg:w-[2500px] w-[1400px] lg:h-[450px] h-[300px] z-3 md:h-[650px] pt-[20px] mt-[30px]  md:mt-[40px] ' />
          </div>
        </motion.div>
    </div>
  )
