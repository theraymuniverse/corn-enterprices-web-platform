  ...
  const [isOpen, setIsOpen] = useState(false);
    ...
    return (
      ...
      <ul className="flex gap-10 text-center  max-sm:hidden text-[20px] pt-[30px]">
        <Link to ='/' ><li className='hover:text-gray-400 cursor-pointer'>
           Home
        </li></Link>
        <Link to = '/products'><li className='hover:text-gray-400 cursor-pointer'>
          Products
        </li></Link>
      ...
      <button className="md:hidden  text-black  " onClick={() => setIsOpen(!isOpen)}>
        ...
        <div className="md:hidden bg-white w-[50rem] py-5">
          ...
          <Link to="/"><li className="hover:text-gray-400 border-b text-green-500 cursor-pointer">
             Home
            </li></Link>
            <Link to='/products'><li className="hover:text-gray-400 border-b text-green-500 cursor-pointer">
              Products
            </li></Link>
            <Link to="" ><li className="hover:text-gray-400 text-green-500 border-b cursor-pointer">
               About us
            </li></Link>
            <li className="hover:text-gray-400 text-green-500 border-b cursor-pointer">
