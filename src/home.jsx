...
const home = () => {
  return (
    ...
    <span className='text-white text-[60px] lg:pt-[20px] font-bold'>
        ...
        <ChevronsDown className='max-sm:hidden animate-bounce justify-self-center md:mt-[80px]  border rounded-full text-center' size={70} />
    </div>    
    </div>
  )
}
