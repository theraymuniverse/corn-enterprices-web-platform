...
const home = () => {
  return (
    ...
    <img loading="lazy" src={second} className='absolute w-full h-[500px] max-sm:h-[650px] md:h-[600px] object-cover mix-blend-overlay' />
    <motion.div 
     initial={{ y:30, opacity: 0, }}
     whileInView= {{ y:0, opacity: 1}}
     transition={{duration: 2}}
    className='p-8 pt-[120px]  md:text-center md:justify-center  text-white '>
    <span
